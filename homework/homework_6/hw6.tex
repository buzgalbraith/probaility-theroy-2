...
\begin{itemize}
    ...
    \item so our $\Tilde{t}_{tail-1}\approx.109\Tilde{z}$ where $\Tilde{z}\sim \mathcal{N}(0,1)$
    ...
    \item so thus we can see that $pv({t}_{data})=P(\Tilde{t}\geq {t}_{data})=P(\Tilde{z}\geq \frac{.263}{.109})\approx0.008$
